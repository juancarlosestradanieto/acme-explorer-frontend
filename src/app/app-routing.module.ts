...
import { PreCancelComponent } from './components/pages/pre-cancel/pre-cancel.component';
...
const routes: Routes = [
  ...
  {
    path:'precancel',component: PreCancelComponent, canActivate: [ActorRoleGuard], data:{ expectedRole: 'MANAGER'}
  },
  {
